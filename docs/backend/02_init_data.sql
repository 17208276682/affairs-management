...
-- 2. 用户数据（8个）
-- 密码说明：
--   admin   -> admin123    （总经办陈志远）
--   wangjh  -> 123456      （技术研发部经理王建华）
...
-- admin123 -> $2a$10$TDdSVrc7o/c0ulRjOCs.yunDcgfRp9J5voZdhytT/U3FL3QgN3MzG
...
('U001', 'admin', '$2a$10$TDdSVrc7o/c0ulRjOCs.yunDcgfRp9J5voZdhytT/U3FL3QgN3MzG', '陈志远', NULL, '13800000001', 'chenzy@company.com', 'D002', '总经理', 'director', 1),
('U002', 'wangjh', '$2a$10$0Le1umMEuXBlSeifDHXXsuK6TOXKJxHI5Y5jLzNryPlLns4zQV9j2', '王建华', NULL, '13800000002', 'wangjh@company.com', 'D003', '技术总监', 'manager', 1),
...
-- 3. 更新部门负责人
-- ============================================
UPDATE departments SET leader_id = 'U001' WHERE id = 'D001';
UPDATE departments SET leader_id = 'U001' WHERE id = 'D002';
UPDATE departments SET leader_id = 'U002' WHERE id = 'D003';
...
UPDATE departments SET member_count = 2 WHERE id = 'D002';  -- 陈志远、赵阳
UPDATE departments SET member_count = 4 WHERE id = 'D003';  -- 王建华、张三、李四、黄晓龙
...
('U001', 'D001'), ('U001', 'D002'), ('U001', 'D003'), ('U001', 'D004'), ('U001', 'D005');
